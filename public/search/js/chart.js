    ...
    w = Oa.Chart = function() {
        ...
        m.prototype._plotAreaMouseMove = function(a, d) {
            if (this.isDrag &&
                ...
                if ((!e || 2 < Math.abs(c) ||
                    ...
                    this.overlaidCanvasCtx.fillStyle = "#000";
        ...
        m.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                else return "y" === a ? fa(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? fa(g, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ?
        ...
        G.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                ...
                else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, n = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (n - this.dataPoints[0].x) >>
